...
const placeholder = "data:image/svg+xml;charset=UTF-8," + encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" width="700" height="700"><defs><radialGradient id="g"><stop stop-color="#2b2b2b"/><stop offset="1" stop-color="#090909"/></radialGradient></defs><rect width="100%" height="100%" fill="url(#g)"/><text x="50%" y="49%" text-anchor="middle" fill="#d7ad6a" font-family="Arial" font-weight="700" font-size="58">HADI</text><text x="50%" y="57%" text-anchor="middle" fill="#ddd" font-family="Arial" font-size="25" letter-spacing="8">MOBILE</text></svg>`);
const DEMO_PRODUCTS = [
